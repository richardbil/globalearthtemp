...
#so now we are interested in sorting the data by country, finding out percentagewise how much data ist missing
#and visually comparing that

without_NaN = global_temp_country[global_temp_country["AverageTemperature"] != "NaN"]
